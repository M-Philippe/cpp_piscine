...
{
	std::cout << "<" << _model << "> " << _name << " attack " << target << " with a gun (ranged) for " << _rgdAttckDmg << " HP" << std::endl;
}

void	ClapTrap::meleeAttack(std::string const& target)
{
	std::cout << "<" << _model << "> " << _name << " attack " << target << " with a knife (melee) for " << _mlAttckDmg << " HP" << std::endl;
}
